...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-chaincoin/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-chaincoin -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-chaincoin -o bitcore-lib-chaincoin.js';
    }
